#
#  Be sure to run `pod spec lint GBUser.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "GBUser"
  s.version      = "1.0.0"
  s.summary      = "GBUser. for quik development "
  ...
  s.description  = <<-DESC
GBUser. for quik development GBUser. for quik development
                   DESC

  s.homepage     = "https://github.com/chenguibang/GBUser.git"
  ...
  s.source       = { :git => "https://github.com/chenguibang/GBUser.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "GBUser", "GBUser/**/*.{h,m}"
  ...
  s.ios.vendored_frameworks = "GBUser/**/*.framework"
  s.ios.vendored_libraries = "GBUser/**/*.a"
